...
export const ActionButton = ({ label, variant = 'default', onClick, rightIcon }: ActionButtonProps) => {
    const classes = ['btn']
    if (variant !== 'default') {
...
export const GithubButton = ({ onClick }: { onClick?: () => void }) => (
    <ActionButton label="Github" variant="primary" onClick={onClick} rightIcon={<GithubIcon />} />
)
